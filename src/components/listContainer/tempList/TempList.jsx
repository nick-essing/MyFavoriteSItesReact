...
export default class TempList extends React.Component {
    ...
    appendList = (searchString) => {
        ...
        <fetchData {"https://chayns1.tobit.com/TappApi/Site/SlitteApp?SearchString=" + searchString + "&Skip="+ tempList.length +"&Take="+ count}>
        {
            .then((data) => {
            this.createTempList(data.Data);
            this.createItemList(); 
    ...
    createItemList = () => {
        for (var i = tempList.length - count; i < tempLi st.length; i++){
